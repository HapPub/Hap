...
class HostCommandError(ValueError):
    def __init__(self, program, code, status='command-failed'):
        ...
        self.next_action = {
            ...
            'jdk-path-encoding-unsupported': 'Choose an ASCII --install-root inside private temporary storage; the current Semeru native library loader cannot represent the real installation path.',
